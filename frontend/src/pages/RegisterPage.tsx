      ...
      >
        ...
        <div className="relative z-10">
          ...
          <p className="text-blue-200 text-lg leading-relaxed max-w-sm">
            Create your patient account and start booking appointments with our expert doctors in seconds.
          </p>
        </div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center px-8 py-12 bg-white">
        <div className="w-full max-w-sm">
          ...
          <div className="lg:hidden flex items-center gap-2 mb-8">
            <div className="w-9 h-9 rounded-xl flex items-center justify-center" style={{ background: '#1a237e' }}>
              <span className="text-white font-bold">+</span>
            </div>
            <span className="font-bold text-lg" style={{ color: '#1a237e' }}>HealthCare</span>
          </div>
